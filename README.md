...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/eRrQNCJNNN)
...
```sh
npx nx serve ThinkTech
```

To create a production bundle:

```sh
npx nx build ThinkTech
```

To see all available targets to run for a project, run:

```sh
npx nx show project ThinkTech
```
